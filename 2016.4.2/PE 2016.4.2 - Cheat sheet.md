...
5. Other puppet commands :
   ...
   Check puppet version :
    ...
    puppet -V
    ```
    Note : The version is the component "puppet" 's version and not PE version. For PE version, the easiest way is to look at the PE console's bottom-left-most text. It should show something like _v 2016.4.2_.
